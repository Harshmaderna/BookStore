...
const Navbar = () => {
  ...
  return (
    <>
      <div
        className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-700 dark:text-white fixed top-0 right-0 z-50 left-0 ${
          sticky
        ...
        <div className="navbar ">
          ...
          <div className="navbar-end space-x-3">
            ...
            <label className="swap swap-rotate">
             ...
             <div className="">
              <a
                className="bg-black px-3 py-2 text-white p-2 rounded-md hover:bg-gray-600 duration-300 cursor-pointer"
